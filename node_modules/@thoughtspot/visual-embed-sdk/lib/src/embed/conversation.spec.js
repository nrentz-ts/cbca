import { SpotterEmbed, ConversationEmbed } from './conversation';
...
describe('ConversationEmbed', () => {
    ...
    it('should handle error when worksheetId is not provided', async () => {
        ...
        await conversationEmbed.render();
        expect(conversationEmbed.handleError).toHaveBeenCalledWith(ERROR_MESSAGE.SPOTTER_EMBED_WORKSHEED_ID_NOT_FOUND);
    });
