import { fetchSessionInfoService, fetchAuthTokenService, fetchAuthService, fetchBasicAuthService, fetchAuthPostService, verifyTokenService, EndPoints, } from '.';
...
describe('Unit test for authService', () => {
    ...
    test('fetchAuthService without username', async () => {
        ...
        expect(fetch).toBeCalledWith(`${thoughtSpotHost}${EndPoints.TOKEN_LOGIN}?auth_token=${authToken}`, {
            credentials: 'include',
            redirect: 'manual',
        });
    });
